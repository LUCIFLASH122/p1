    ...
    <SafeAreaView className="flex-1 justify-center items-center p-4">
      ...
      <View className="w-full">
        ...
        <TextInput
          ...
          className={`w-full border ${isFocused ? 'border-blue-500' : 'border-gray-200'} rounded-full py-3 px-4`}
        ...
        <TextInput
          ...
          onBlur={() => setIsFocused(false)}
        />
        <TouchableOpacity className="mt-4 bg-red-700 border border-red-600 rounded-xl py-3 px-6" onPress={() => console.log('Details Sent')}>
